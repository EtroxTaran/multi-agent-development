...
<!-- SHARED: Historical lessons for reference -->
<!-- Moved from lessons-learned.md for context optimization -->
<!-- Version: 1.0 -->
<!-- Last Updated: 2026-01-27 -->

This file contains archived lessons. For recent lessons, see `lessons-learned.md`.

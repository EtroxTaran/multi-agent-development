...
<!-- Last synced: 2026-01-28 20:12:35 -->
...
| Routine verification | agent | Standard Phase 4 reviews |
...
### When to Use Cursor Plan Mode

**Use plan mode (`--mode=plan`):**
- Complex multi-file architecture reviews
- Validations requiring extensive codebase research
- When the review scope is unclear

**Use agent mode (default):**
- Standard Phase 2 plan validation
- Standard Phase 4 code verification
...
### 2026-01-28 - Cursor CLI Plan Mode Support (Jan 2026 Update)

- **Issue**: Documentation incorrectly stated Cursor CLI doesn't support plan mode
- **Root Cause**: Cursor CLI Jan 16, 2026 update added `--mode=plan` and `--mode=ask` flags, which weren't reflected in docs
- **Fix**: Updated CLI reference, CursorAgent class, and call-cursor.sh to support `--mode` flag with agent/plan/ask modes
- **Prevention**: Always verify tool capabilities with web research before documenting limitations; CLI tools evolve rapidly
- **Applies To**: cursor

...
export class WorkflowStatusResponseDto {
  ...
  @ApiProperty({ description: 'Status of each phase', additionalProperties: { type: 'string' } })
...
export class WorkflowHealthResponseDto {
  ...
  @ApiProperty({ description: 'Agent availability', additionalProperties: { type: 'boolean' } })
...
export class WorkflowStartRequestDto {
  @ApiProperty({ description: 'Starting phase', default: 1, minimum: 1, maximum: 5 })
  @IsInt()
  @Min(1)
  @Max(5)
  @IsOptional()
  ...
  @ApiProperty({ description: 'Ending phase', default: 5, minimum: 1, maximum: 5 })
  @IsInt()
  @Min(1)
  @Max(5)
  @IsOptional()
  ...
  @ApiProperty({ description: 'Run autonomously without human input', default: false })
  @IsBoolean()
  @IsOptional()

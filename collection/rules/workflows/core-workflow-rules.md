---
name: Core Workflow Rules
tags:
  technology: [python, typescript, javascript]
  feature: [workflow, collaboration]
  priority: critical
summary: Core workflow rules that apply to all agents in the Conductor system
version: 1
---
...
- **No Monoliths**: Do not assume huge monolithic files exist. Follow the links.
